...
/**
 * TODO Write tests to find errors in the following methods, then fix them. You
 * MUST write the tests before you fix the errors.
 */
public class FixMeApp {
	...
	/**
	 * Concatenates a message a specified number of times. For example, given
	 * "Hello", 3, it returns "HelloHelloHello".
	 * 
