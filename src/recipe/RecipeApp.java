...
public class RecipeApp {
	...
	public static void main(String[] args) {
		...
		b.ingredients​.add(new Ingredient("Apple", "", 5.0));
		b.ingredients​.add(new Ingredient("Sugar", "c", 0.125));
		b.ingredients​.add(new Ingredient("Cinnamon", "TBSP", 1.0));
		...
		r.ingredients​.add(new Ingredient("Marshmellow", "", 1.0));
		r.ingredients​.add(new Ingredient("Chocolate", "oz", 0.5));
		r.ingredients​.add(new Ingredient("Grahm cracker", "", 1.0));
		...
		// enhanced for loop
		// for (data type, name : list to loop through)

		for (Ingredient ing : r.ingredients​) {
			System.out.println(ing);
		}
		for (Ingredient abc : b.ingredients​) {
